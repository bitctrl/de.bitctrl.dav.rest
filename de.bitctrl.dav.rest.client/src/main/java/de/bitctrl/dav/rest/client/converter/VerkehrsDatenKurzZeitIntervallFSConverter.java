 ...
 *
 */
@DavJsonDatensatzConverter(davAttributGruppe = { "atg.verkehrsDatenKurzZeitIntervall" })
public class VerkehrsDatenKurzZeitIntervallFSConverter implements DavJsonConverter<ResultData, VerkehrsdatenKurzzeit> {
